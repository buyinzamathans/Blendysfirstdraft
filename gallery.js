...
(function () {
        ...
        return (
            '<figure class="tile" data-category="' + item.category + '" data-index="' + idx + '" data-id="' + item.id + '" tabindex="0" role="button" aria-label="View ' + item.categoryLabel + ' photo ' + idx + '">' +
                '<div class="tile-frame">' +
                    '<img src="' + item.thumb + '" alt="' + item.categoryLabel + ' by Blendy\'s" loading="lazy" width="' + item.w + '" height="' + item.h + '">' +
                '</div>' +
                '<div class="tile-seal" aria-hidden="true">' +
                    '<svg viewBox="0 0 24 24" fill="#E3A62A" xmlns="http://www.w3.org/2000/svg"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>' +
                '</div>' +
    ...
    function renderLightbox() {
        ...
        lightboxImg.alt = item.categoryLabel + ' — Blendy\'s, Kampala';
